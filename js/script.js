...
(function ($) {
    ...
    MYAPP.instaFeed = { count: 0, prefix: 'instagramFeed_', clientId: 'a109b7fe3eeb4303a0e9b11aa5d2e9e7' }; //*** PUT YOUR OWN INSTAGRAM CLIENT_ID !!!
    ...
    MYAPP.carouselsAuto = {
        ...
        latestWorkCarousel: false, //** Lates Work carousel in main page
    ...
    if (typeof NProgress !== 'undefined') {
        $('mainSliderContainer').addClass('loading');
        NProgress.start();
    ...
    $(window).load(function () {
        ...
        $('#loader').remove();
        $('mainSliderContainer').removeClass('loading');
        if ($('.mainSlider').css('opacity') < 0)
            $('.mainSlider').animate({ opacity: 0 }, 500);
        //** END LOADER ANIMATION
        ////////////////////////////////////////////
